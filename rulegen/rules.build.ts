...
const path = new URL(import.meta.url.slice(0, import.meta.url.lastIndexOf("/")) + "/rules.ts");
const dir = new URL(import.meta.url.slice(0, import.meta.url.lastIndexOf("/")) + "/rules/apps/");
